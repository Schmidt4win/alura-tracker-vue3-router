<template>
  <div class="page-container">
    ...
    <div class="">
      <input class="input" type="text" v-model="searchQuery" placeholder="Pesquisar cliente por nome" />
    ...
    <!-- The Modal component -->
    <ModalSignal :selectedClient="selectedClient" :clientDataByDate="clientDataByDate" @close="closeModal" />
...
.caixa-nomes {
  margin-bottom: 10px;
  padding: 1.25rem;
  border: 2px solid #e96d13;
  /* Adding a border */
  border-radius: 5px;
  /* Rounded corners */
  background-color: #f9f9f9;
  /* Background color for the names box */
  cursor: pointer;
