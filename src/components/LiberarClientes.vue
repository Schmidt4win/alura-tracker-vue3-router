      ...
      <Box class="box" v-for="result in apiResults" :key="result.onuMac">
        <div class="is-flex is-justify-content-space-between">
          ...
          <div class="buttons is-flex">
            <button class="button is-primary is-fullwidth" @click="openLiberationModal(result)">
              Liberar
            </button>
            <button class="button is-primary is-fullwidth" @click="verificarSinal(result)">
              Verificar Sinal
            </button>
          </div>
        </div>
        ...
        <div class="modal" :class="{ 'is-active': showLiberationModal }">
            ...
            <div class="modal-card">
                <header class="modal-card-head">
                    ...
                    <button class="delete" aria-label="close" @click="closeLiberationModal"></button>
                </header>
                <section class="modal-card-body">
                    <div class="field">
                        <label class="label">Nome do cliente</label>
                        <div class="control">
                            <input class="input" type="text" v-model="onu.onuAlias" placeholder="Nome do cliente"
                                name="onuAlias" required />
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" type="text" v-model="onu.Tecnico" placeholder="Nome do Técnico"
        ...
        <SignalModal :showModal="showSignalModal" :selectedOnu="selectedOnu" @close="closeSignalModal" />
    </div>
...
export default defineComponent({
    ...
    methods: {
        ...
        async verificarSinal(cliente: IAllOnuLiberarData) {
            try {
        ...
        async cadastrarOnu(result) {
            ...
            const combinedData: IOnuDataResponse & IAllOnuLiberarData = {
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    const { oltIp, onuMac } = this.selectedOnu;
                    console.log(oltIp, onuMac);
                   this.verificarSinal({ oltIp, onuMac });
